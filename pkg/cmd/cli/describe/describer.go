...
func describerMap(c *client.Client, kclient kclient.Interface, host string) map[unversioned.GroupKind]kctl.Describer {
	m := map[unversioned.GroupKind]kctl.Describer{
		...
		applicationapi.Kind("Application"):                       &ApplicationDescriber{c, kclient},
		servicebrokerapi.Kind("ServiceBroker"):                   &ServiceBrokerDescriber{c},
		backingserviceapi.Kind("BackingService"):                 &BackingServiceDescriber{c, kclient},
		backingserviceinstanceapi.Kind("BackingServiceInstance"): &BackingServiceInstanceDescriber{c, kclient},
	}
	return m
}
...
func (d *ServiceBrokerDescriber) Describe(namespace, name string, settings kctl.DescriberSettings) (string, error) {
	c := d.ServiceBrokers()
	bs, err := c.Get(name)
	if err != nil {
		return "", err
...
func (d *BackingServiceDescriber) Describe(namespace, name string, settings kctl.DescriberSettings) (string, error) {
...
func (appDescriber *ApplicationDescriber) Describe(namespace, name string, settings kctl.DescriberSettings) (string, error) {
...
func (d *BackingServiceInstanceDescriber) Describe(namespace, name string, settings kctl.DescriberSettings) (string, error) {
